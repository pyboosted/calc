...
describe("Calculator Engine Variable Reassignment", () => {
  test("should handle variable reassignment across lines", () => {
    ...
    if (lines[0]?.result?.type === "number") {
      expect(fromDecimal(lines[0]?.result?.value)).toBe(1);
    }
    expect(lines[1]?.result?.type).toBe("number");
    if (lines[1]?.result?.type === "number") {
      expect(fromDecimal(lines[1]?.result?.value)).toBe(1);
    }
    ...
    if (lines[2]?.result?.type === "number") {
      expect(fromDecimal(lines[2]?.result?.value)).toBe(2);
    }
    expect(lines[3]?.result?.type).toBe("number");
    if (lines[3]?.result?.type === "number") {
      expect(fromDecimal(lines[3]?.result?.value)).toBe(2);
    }
  });
  ...
  test("should propagate variable changes to subsequent lines", () => {
    ...
    expect(lines[0]?.result?.type).toBe("number");
    if (lines[0]?.result?.type === "number") {
      expect(fromDecimal(lines[0]?.result?.value)).toBe(10);
    }
    expect(lines[1]?.result?.type).toBe("number");
    if (lines[1]?.result?.type === "number") {
      expect(fromDecimal(lines[1]?.result?.value)).toBe(20);
    }
    expect(lines[2]?.result?.type).toBe("number");
    if (lines[2]?.result?.type === "number") {
      expect(fromDecimal(lines[2]?.result?.value)).toBe(20);
    }
    ...
    expect(lines[3]?.result?.type).toBe("number");
    if (lines[3]?.result?.type === "number") {
      expect(fromDecimal(lines[3]?.result?.value)).toBe(5);
    }
    expect(lines[4]?.result?.type).toBe("number");
    if (lines[4]?.result?.type === "number") {
      expect(fromDecimal(lines[4]?.result?.value)).toBe(20);
    }
    ...
    lines = engine.getLines();
    expect(lines[5]?.result?.type).toBe("number");
    if (lines[5]?.result?.type === "number") {
      expect(fromDecimal(lines[5]?.result?.value)).toBe(10);
    }
    expect(lines[6]?.result?.type).toBe("number");
    if (lines[6]?.result?.type === "number") {
      expect(fromDecimal(lines[6]?.result?.value)).toBe(10);
    }
  });
  ...
  test("should handle multiple reassignments in sequence", () => {
    ...
    expect(lines[1]?.result?.type).toBe("number");
    if (lines[1]?.result?.type === "number") {
      expect(fromDecimal(lines[1]?.result?.value)).toBe(2);
    }
    expect(lines[2]?.result?.type).toBe("number");
    if (lines[2]?.result?.type === "number") {
      expect(fromDecimal(lines[2]?.result?.value)).toBe(3);
    }
    expect(lines[3]?.result?.type).toBe("number");
    if (lines[3]?.result?.type === "number") {
      expect(fromDecimal(lines[3]?.result?.value)).toBe(3);
    }
  });
  ...
  test("should handle reassignment with units", () => {
    ...
    if (result0?.type === "quantity") {
      expect(fromDecimal(result0.value)).toBe(100);
    ...
    if (result3?.type === "quantity") {
      expect(fromDecimal(result3.value)).toBe(5);
